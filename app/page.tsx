...
const stores: Store[] = [
  ...
  ["Agrivet Supplies", "Agrivet Supplies", "/store/agri.jpg", "Farming essentials", ["Feeds and farm supply tracking", "Livestock product management", "Supplier and stock monitoring", "Sales reports for your store"], false, "Manage farm supplies, feeds, livestock products, and suppliers with ease."],
